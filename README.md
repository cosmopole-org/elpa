...
| `examples/material` | **Material Design 3 UI kit as Elpian AST** (`assets/*.ast.json`): interactive buttons/FAB/switch/checkbox/radios/slider/chips/progress; every event wired branch-free in the VM | ✅ tested |
